...
<head>
    ...
    <title>Nova Alocação - Sistema de Escala Médica</title>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">📅 Nova Alocação</h5>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form action="{{ route('alocacoes.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="plantonista_id" name="plantonista_id" required>
                                        ...
                                        <option value="{{ $plantonista->id }}" {{ old('plantonista_id') == $plantonista->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="vaga_id" name="vaga_id" required>
                                        ...
                                        <option value="{{ $vaga->id }}" {{ old('vaga_id') == $vaga->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="data_plantao" name="data_plantao" value="{{ old('data_plantao') }}" required>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="observacoes" name="observacoes" rows="3" placeholder="Observações sobre a alocação...">{{ old('observacoes') }}</textarea>
                            </div>

                            <div class="alert alert-info">
                                <small><strong>ℹ️ Nota:</strong> Os horários de início e fim serão calculados automaticamente com base no turno selecionado.</small>
                            </div>

                            <div class="d-flex justify-content-between">
                                <a href="{{ route('alocacoes.index') }}" class="btn btn-secondary">🔙 Cancelar</a>
